                  ...
                  <div>
                     ...
                     <div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-4">
                              <form class="text-end">
                                 <input type="image" src="{{asset('assets/images/other-images/paypal.png')}}" name="submit" alt="PayPal - The safer, easier way to pay online!" data-bs-original-title="" title="">
                              </form>
                           </div>
                        </div>
                     </div>
